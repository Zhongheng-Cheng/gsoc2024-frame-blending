...
SYSTEM_PROMPT = """You are an AI assistant in linguistics that answers questions about frame blending, all the anaylitical process should based on the given source documents which are all the frame dataset of FrameNet. Here are some rules you always follow:
...
response = query_engine.query('''Please randomly pick two frames from the FrameNet dataset, and tell me what you have picked. Then, generate an example of frame blending with the two frames that you picked, along with the analysis process similar to the example I provide you. Here is an example of frame blending: 
    # Expression
    "Time is money."
    # Frames Involved:
    ## Time Frame
